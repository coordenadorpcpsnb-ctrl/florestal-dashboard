...
import { buscarNoticiasFertilizantes } from "./fetch-noticias.mjs";
...
const noticiasFert = await buscarNoticiasFertilizantes(status);
...
const out = {
  ...
  noticiasFert: noticiasFert.length ? noticiasFert : (prev?.noticiasFert ?? []),
};
